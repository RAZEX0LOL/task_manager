...
import {AddUser, Button, ConfirmatioDialog, Loading, Title, UserAction,} from "../components";
  ...
  return isLoading ? (
    ...
    <>
      <div className='w-full md:px-1 px-0 mb-6'>
        ...
        <div className='bg-stone-900 dark:bg-[#1f1f1f] px-2 md:px-4 py-4 shadow rounded'>
