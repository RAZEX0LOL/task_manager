...
import {getCompletedSubTasks, getInitials, PRIOTITYSTYELS, TASK_TYPE,} from "../utils";
...
const TABS = [
  { title: "Детали задачи", icon: <FaTasks /> },
  { title: "Активности/Хронология", icon: <RxActivityLog /> },
];
...
const Activities = ({ activity, id, refetch }) => {
  ...
  return (
    <div className='w-full flex gap-10 2xl:gap-20 min-h-screen px-10 py-8 bg-stone-900 shadow rounded-md justify-between overflow-y-auto'>
      <div className='w-full md:w-1/2'>
        <h4 className='text-gray-200 font-semibold text-lg mb-5'>Активности</h4>
      ...
      <div className='w-full md:w-1/3'>
        ...
        <div className='w-full flex flex-wrap gap-5'>
          ...
          <textarea
            ...
            placeholder='Тип ......'
            className='bg-stone-900 w-full mt-10 border border-gray-300 outline-none p-4 rounded-md focus:ring-2 ring-blue-500'
          ></textarea>
          {isLoading ? (
            <Loading />
          ) : (
            <Button
              ...
              className='bg-blue-600 text-gray-200 rounded'
            />
          )}
        </div>
      </div>
  ...
  return (
    <div className='w-full flex flex-col gap-3 mb-4 overflow-y-hidden'>
      ...
      <Tabs tabs={TABS} setSelected={setSelected}>
        {selected === 0 ? (
          <>
            <div className='w-full flex flex-col md:flex-row gap-5 2xl:gap-8 bg-stone-900 shadow rounded-md px-8 py-8 overflow-y-auto'>
              <div className='w-full md:w-1/2 space-y-8'>
                <div className='flex items-center gap-5'>
                  ...
                  >
                    ...
                    <span className='uppercase'>{task?.priority} ПРИОРИТЕТ</span>
                  </div>

                  <div className={clsx("flex items-center gap-2")}>
                    <TaskColor className={TASK_TYPE[task?.stage]} />
                    <span className='text-gray-200 uppercase'>{task?.stage}</span>
                  </div>
                </div>

                <p className='text-gray-500'>
                  Создано: {new Date(task?.date).toDateString()}
                </p>

                <div className='flex items-center gap-8 p-4 border-y border-gray-200'>
                  <div className='space-x-2'>
                    <span className='font-semibold'>Ассеты :</span>
                        ...
                        <div key={index + el?._id} className='flex gap-3'>
                          ...
                          <div className='space-y-1'>
                            <div className='flex gap-2 items-center'>
                              ...
                              >
                                {el?.isCompleted ? "выполнено" : "в работе"}
                              </span>
                            </div>
              ...
              <div className='w-full md:w-1/2 space-y-3'>
                {task?.description && (
                  <div className='mb-10'>
                    <p className='text-lg font-semibold'>ОПИСАНИЕ ЗАДАЧИ</p>
                ...
                {task?.assets?.length > 0 && (
                  <div className='pb-10'>
                    <p className='text-lg font-semibold'>АССЕТЫ</p>
                ...
                {task?.links?.length > 0 && (
                  <div className=''>
                    <p className='text-lg font-semibold'>ДОПОЛНИТЕЛЬНЫЕ ССЫЛКИ</p>
