...
const StatusPage = () => {
  ...
  const TableHeader = () => (
      ...
      <tr className='text-black dark:text-white text-left'>
          <th className='py-2'>Полное имя</th>
          <th className='py-2'>Должность</th>
          <th className='py-2'>Прогресс задач</th>
          <th className='py-2'>Количество задач</th>
          <th className='py-2'>Всего задач</th>
      </tr>
      </thead>
  );
    ...
    <>
      <div className='w-full md:px-1 px-0 mb-6'>
        <div className='flex items-center justify-between mb-8'>
          <Title title='Статусы задач пользователей' />
        </div>
        <div className='bg-stone-900 dark:bg-[#1f1f1f] px-2 md:px-4 py-4 shadow-md rounded'>
