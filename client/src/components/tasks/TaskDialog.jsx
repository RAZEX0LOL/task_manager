  ...
  return (
    <>
      <Menu as='div' className='relative inline-block text-left'>
        ...
        <CustomTransition>
          <Menu.Items className='absolute p-4 left-0 mt-2 w-40 divide-y divide-gray-100 rounded-md bg-stone-900 shadow-lg ring-1 ring-black/5 focus:outline-none'>
...
export default function TaskDialog({ task }) {
  ...
  return (
    <>
      <div className=''>
        <Menu as='div' className='relative inline-block text-left'>
          <Menu.Button className='inline-flex w-full justify-center rounded-md px-4 py-2 text-sm font-medium text-gray-200 dark:text-gray-300'>
            <BsThreeDots />
          </Menu.Button>

          <CustomTransition>
            <Menu.Items className='absolute p-4 right-0 mt-2 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-stone-900 shadow-lg ring-1 ring-black/5 focus:outline-none'>
              <div className='px-1 py-1 space-y-2'>
                {items.map((el, index) => (
                ...
                <Menu.Item>
                  {({ active }) => (
                    <button
                      ...
                      className={`${
                        active ? "bg-red-400 text-red-600" : "text-red-600"
                      } group flex w-full items-center rounded-md px-2 py-2 text-sm disabled:text-gray-400`}
                    >
                      <RiDeleteBin6Line
