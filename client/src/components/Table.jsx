...
const Table = ({ tasks }) => {
    ...
    const TableHeader = () => (
        ...
        <tr className='w-full text-black dark:text-white text-left'>
            ...
            <th className='py-2 line-clamp-1'>Создано</th>
            ...
            <td className='py-2'>
                <Link to={`/task/${task._id}`}>
                    <div className='flex items-center gap-2'>
                        ...
                        <p className='w-full line-clamp-2 text-base text-gray-200'>
                            {task?.title}
                        </p>
                    </div>
                </Link>
    ...
    return (
        <>
            <div className='bg-stone-900  px-2 md:px-4 pt-4 pb-9 shadow-md rounded'>
